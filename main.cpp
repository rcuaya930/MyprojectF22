...
const vector<string> specializations {"Anetheiology", "Hematology", "Urology", "Pathology", "Infectious disease"};

const vector<string> languages {"French", "Cantonese", "English", "Hindi", "Spanish", "Portugese", "Korean", "Afrikaans", "Oshiwambo", "Mandarin", "Russian", "Arabic", "Estonian", "Malay", "Argentina", "German", "Slovakian", "Haitian"}; 

const vector<string> countries {"France", "China", "United States", "India", "Mexico", "Brazil", "South Korea", "South Africa", "Namibia", "China", "Russia", "Egypt", "Estonia", "Haiti"}; 
